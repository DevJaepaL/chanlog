  ...
  return (
    <section className="break-keep">
      <div className="my-3 flex flex-col items-center gap-4 text-stone-900">
        ...
        <div className="flex flex-col justify-items-center my-3">
          <p className="font-bold text-3xl text-stone-800">Jae Chan</p>
          <p className="mb-3 text-xs text-zinc-400">Back-End Developer</p>
          <p className="mb-1 items-center text-sm">바삐 흘러가는 중심에서<br/>생각을 정리하고 순간을 기록합니다.</p>
        </div>        
      </div>      
      <div className="w-[100%] my-[5%] border-[2px] border-black/60"></div>
      <section className="mb-10">
      <h1 className="mb-6 text-2xl font-bold text-stone-800">최근 작성한 것들</h1>
      {allPosts
        .sort((a, b) => {
